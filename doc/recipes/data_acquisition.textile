...
processing for performance reasons.  This makes it possible to create Records
...
generating a Record for them.  The snippet below will create a Data::Table which
...
Records for its iterator, ensuring that a much lighter structure is used for
comparison.
