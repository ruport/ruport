...
module Ruport
  ...
  class Formatter::HTML < Formatter    
    ...
    def build_table_header
      output << build_header(options.show_table_headers != false ? data.column_names : nil)
    end
    ...
    def render_justified_grouping
      output << build_header(options.show_table_headers != false ? ([data.grouped_by] + grouping_columns) : nil)
